---
name: banner-design
description: "Design banners for social media, ads, website heroes, creative assets, and print. Multiple art direction options with AI-generated visuals. Actions: design, create, generate banner. Platforms: Facebook, Twitter/X, LinkedIn, YouTube, Instagram, Google Display, website hero, print. Styles: minimalist, gradient, bold typography, photo-based, illustrated, geometric, retro, glassmorphism, 3D, neon, duotone, editorial, collage. Uses ui-ux-pro-max, ui-styling, design skills."
...
2. **Generate visual elements** — Grok `GenerateImage` hoặc `design/scripts/` (cần `GEMINI_API_KEY`)

   - Background/pattern: prompt ngắn, no-text, khớp aspect ratio platform
   - Hero/illustration: mô tả style, lighting, mood, palette
...
1. **Serve HTML** — `python -m http.server 8765` (repo root hoặc thư mục banner)
2. **Screenshot** — Playwright/Puppeteer headless hoặc `chromium --headless --screenshot` tại đúng width×height
3. **Compress** — nếu >5MB, dùng `sharp`/`imagemagick` giảm dung lượng
