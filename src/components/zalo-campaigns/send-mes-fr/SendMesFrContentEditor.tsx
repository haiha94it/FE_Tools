...
import { getSendMesFrMediaUrl } from "@/lib/zalo-send-mes-fr-campaign-utils";
import { toast } from "@/lib/toast";
import type { SendMesFrContentType } from "@/types/zalo-send-mes-fr-campaign";
...
export default function SendMesFrContentEditor({
  contents,
  images,
  contentType,
  uploadingImage,
